...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { forum_id: @subject.forum_id, subject: @subject.subject } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { forum_id: @subject.forum_id, subject: @subject.subject } }
